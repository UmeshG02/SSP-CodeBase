...
-- CreateEnum
CREATE TYPE "ChallengeType" AS ENUM ('CODING', 'SQL', 'APTITUDE', 'INTERVIEW', 'PUZZLE');
...
CREATE TABLE "Profile" (
    ...
    "company" TEXT,
    "skills" TEXT[],
    "prefLang" TEXT NOT NULL DEFAULT 'JavaScript',
    "expLevel" TEXT NOT NULL DEFAULT 'Beginner',
